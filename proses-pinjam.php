<?php
	...
	if(!empty($_GET['username']) && $_GET['username'] != ""){
		...
		$search_barang 	= mysqli_query($mysqli, "SELECT * FROM tbl_barang WHERE id='$id_barang'");
...
<html>
<head>
	<title>Peminjaman | Inventori Bahan Bangunan</title>
	...
	<div class="container">
		<div class='row'>
			...
			<div class="col-md-4 form-register-container">
				<h2 class="">Form Peminjaman Barang</h2>
				<form action="request-barang.php" method="post">
					...
					<div class="form-group">
						...
						<div class="input-group date form_datetime" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
							<input class="form-control" size="16" type="text" value="" name="tgl_pinjam">
					...
					<div class="form-group">
						...
						<div class="input-group date form_datetime" data-date-format="dd MM yyyy - HH:ii p" data-link-field="dtp_input1">
							<input class="form-control" size="16" type="text" value="" name="tgl_kembali">
							<span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
							<span class="input-group-addon"><span class="glyphicon glyphicon-th"></span></span>
						</div>
						<input type="hidden" id="dtp_input1" value="" />
					</div>
					<button type="submit" name="request-pinjam" class="btn btn-success" style="margin-top: 20px;">Proses Peminjaman</button>
				</form>
			</div>
		</div>
	</div>
