<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['id_transaksi'])) {
        ...
        // Lakukan pengecekan keamanan tambahan jika diperlukan sebelum menghapus data

        // Lakukan perintah SQL untuk menghapus data transaksi berdasarkan id transaksi
        $query = "DELETE FROM tbl_transaksi WHERE id = '$id_transaksi'";
        if (mysqli_query($mysqli, $query)) {
            echo "<script>alert('Data transaksi berhasil dihapus');</script>";
            echo "<script>window.location='index.php';</script>";
        } else {
            echo "<script>alert('Gagal menghapus data transaksi');</script>";
            echo "<script>window.location='index.php';</script>";
        }
    }
?>
...
<head>
    ...
    <title>Admin - Inventori Bahan Bangunan</title>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="data-laporan.php" class="btn btn-danger btn-sm" style="margin-left: 20px;">
